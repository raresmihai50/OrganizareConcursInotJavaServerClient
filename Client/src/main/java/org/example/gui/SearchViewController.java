...
public class SearchViewController {
    ...
    public void initSearchViewController(IService serv, Stage dialogStage) {
    ...
    public void handleSearch() throws MessageError {
        ...
        if (trials.isEmpty()) {
            ...
            try {
                participants = serv.findParticipantsByTrials(trials);
